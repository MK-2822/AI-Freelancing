...
urlpatterns = [
    ...
    path('projects', ProjectListCreateView.as_view(), name='projects'), # Handles GET /projects and POST /projects/create
    path('projects/create', ProjectListCreateView.as_view(), name='projects-create'), # Explicit alias
